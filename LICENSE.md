...
## Preamble/intro
This software license may be freely used in unmodified form (with exceptions). A work may only be copyrighted under this license in its unmodified form, or with some subsections removed or swapped out.

## Overview
Copyright Owner: Kristijan Grozdanovski
Product Name: Jarvis

## License Modifications
Source code is NOT provided. Warranty is NOT given. You are allowed to have this software installed on any number of machine(s) at once. Commercial or educational use is NOT allowed.

Definitions "Product", or "software" refers to the work that is copyrighted under this license.

"We", or "us" refers to the copyright owner of this product. That owner is Kristijan Grozdanovski.
